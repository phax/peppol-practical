...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="BIIRULES T02 bound to UBL">
      <xsl:comment>
      ...
      <svrl:ns-prefix-in-attribute-values prefix="ubl" uri="urn:oasis:names:specification:ubl:schema:xsd:OrderResponseSimple-2" />
      <svrl:active-pattern>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>BIIRULES T02 bound to UBL</svrl:text>
