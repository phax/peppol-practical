...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="T02" id="UBL-T02">
  ...
  <param name="BIIRULE-T02-R004" value="not(cbc:Note) or count(cbc:Note)=1" />
  <param name="BIIRULE-T02-R005" value="(@languageID)" />
  <param name="BIIRULE-T02-R006" value="(cac:Party/cac:PartyName/cbc:Name)" />
  <param name="BIIRULE-T02-R007" value="(cac:Party/cac:PartyName/cbc:Name)" />
