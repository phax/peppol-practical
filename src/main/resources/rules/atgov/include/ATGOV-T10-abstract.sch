...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="T10">
  ...
  <rule context="$Invoice">
    ...
    <assert flag="fatal" test="$ATGOV-T10-R003">[ATGOV-T10-R003]-The order number or buyer group must be present.</assert>
    <assert flag="warning" test="$ATGOV-T10-R005">[ATGOV-T10-R005]-Exactly 1 beneficiary account may be present.</assert>
    <assert flag="fatal" test="$ATGOV-T10-R009">[ATGOV-T10-R009]-At last 2 cashbacks may be present.</assert>
  ...
  <rule context="$Invoice_Line">
    ...
    <assert flag="fatal" test="$ATGOV-T10-R015">[ATGOV-T10-R015]-The gross amount of a single invoice line must be greater or equal than -999999999999.99 and smaller or equal than 999999999999.99.</assert>
  </rule>
  <rule context="$Payment_Terms">
    <assert flag="warning" test="$ATGOV-T10-R004">[ATGOV-T10-R004]-An invoice should not specify only textual payment terms.</assert>
    <assert flag="fatal" test="$ATGOV-T10-R010">[ATGOV-T10-R010]-The percentage of a cashback item must be greater 0 and lower than 100.</assert>
  </rule>
</pattern>
