...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="ATNAT T10 bound to UBL">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>ATNAT T10 bound to UBL</svrl:text>
...
<!--PATTERN UBL-T10-->
	...
	<!--RULE -->
<xsl:template match="//cac:TaxCategory" mode="M11" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice" mode="M11" priority="1000">
