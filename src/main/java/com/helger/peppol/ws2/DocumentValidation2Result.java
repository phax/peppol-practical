...
public final class DocumentValidation2Result
{
  ...
  private List <DocumentValidation2ResultItem> m_aItems;

  public DocumentValidation2Result ()
  {}
  ...
  public List <DocumentValidation2ResultItem> getItems ()
  {
    if (m_aItems == null)
