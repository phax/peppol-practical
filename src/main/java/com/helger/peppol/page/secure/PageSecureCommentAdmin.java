...
{
  public static final class ComparatorObjectTypeName extends AbstractComparator <ObjectType>
  {
    @Override
    protected int mainCompare (@Nonnull final ObjectType aElement1, @Nonnull final ObjectType aElement2)
    {
      return aElement1.getObjectTypeName ().compareTo (aElement2.getObjectTypeName ());
    }
  }
