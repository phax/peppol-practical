...
public final class AppSecurity
{
  ...
  public static void init ()
  {
    ...
    if (!aRoleMgr.containsRoleWithID (CApp.ROLE_COMMENT_MODERATOR_ID))
      aRoleMgr.createPredefinedRole (CApp.ROLE_COMMENT_MODERATOR_ID,
    ...
    aUserGroupMgr.assignRoleToUserGroup (CApp.USERGROUP_ADMINISTRATORS_ID, CApp.ROLE_COMMENT_MODERATOR_ID);
