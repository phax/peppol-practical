 ...
 */
public final class AjaxExecutorPublicCommentAdd extends AbstractAjaxExecutor
{
  ...
  private static final Logger s_aLogger = LoggerFactory.getLogger (AjaxExecutorPublicCommentAdd.class);
